...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Amber Webapi web application."
  #
  #
  ...
  #
  # settings.secret_key_base= V_eyY_vlAeP8YZTVd5Ql8PRnebHNj6xkALAHL6Qnbqs
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("amber_webapi.log", "w"))
  #
  #
end
